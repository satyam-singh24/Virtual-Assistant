...
int main()
{
    ...
    cout<<"\t\t\t<============================================= MY NAME IS SATYAM SINGH ==========================================>"<<endl;
        ...
        if(strcmp(password, "inertia")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my master SATYAM SINGH !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master SATYAM SINGH";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
